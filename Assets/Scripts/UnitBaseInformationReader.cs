...
public class UnitBaseInformationReader : SingletonWithoutMonobehaviour<UnitBaseInformationReader>
{
    ...
    public void Read()
    {
        ...
        foreach (var recipe in list)
        {
            ...
            unitBaseInformations.Add(recipe["RecipeName"].ToString(), temp);
        }
    }
}
